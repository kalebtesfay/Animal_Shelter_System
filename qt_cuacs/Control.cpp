...
void Control::dbLaunch(){
    ...
    db.setDatabaseName("/home/student/COMP3004/Animal_Shelter_System/qt_cuacs/database/database.db");
    ...
    QSqlQuery query("CREATE TABLE ANIMAL(id TEXT PRIMARY KEY, name TEXT, type TEXT, sex TEXT, age INT, height TEXT, colour TEXT, breed TEXT, neutered TEXT, condition TEXT)");
